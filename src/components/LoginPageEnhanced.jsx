      ...
      <div className="max-w-4xl w-full">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to access your personal AI writing assistant</p>
            </div>
            ...
            >
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-gray-500 text-sm">Quick & secure authentication</div>
                </div>
        ...
        <div className="text-center mt-8">
          <div className="inline-flex items-center gap-2 bg-white rounded-full px-6 py-3 shadow-sm border border-gray-100">
            ...
            <span className="text-sm text-gray-700">Join thousands of professionals getting their dream jobs</span>
            <Star className="w-4 h-4 text-yellow-500" />
          </div>
        </div>
      </div>
