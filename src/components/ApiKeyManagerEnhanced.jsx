            ...
            {steps.map((_, index) => (
              <div key={index} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div className={`w-16 h-1 mx-2 rounded ${index + 1 < step ? "bg-indigo-600" : "bg-gray-200"}`} />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          {step === 1 && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                You're about to unlock the power of AI-generated cover letters. Let's get you set up with access to
                multiple Gemini AI models.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {aiModels.map((model, index) => (
                  <div key={index} className="bg-gray-50 rounded-xl p-4">
                    <div
                      className={`w-10 h-10 rounded-lg ${model.bgColor} flex items-center justify-center mx-auto mb-2`}
                    >
          ...
          {step === 2 && (
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Follow these simple steps to get your Gemini API key from Google</p>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Come back and paste your API key in the next step</p>
                  </div>
                </div>
              </div>
          ...
          {step === 3 && !success && (
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Your API key will be encrypted and stored securely</p>
              </div>
          ...
          {(step === 4 || success) && (
            <div className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Perfect! You're All Set</h3>
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Your API key has been saved securely. You can now generate professional cover letters using multiple AI
                models. Let's create your first cover letter!
              </p>
